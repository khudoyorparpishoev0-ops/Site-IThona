...
const I18N = {
  ru: {
    ...
    stat_quality:"гарантия качества и надежности",
    v2_eyebrow:"Системный IT-интегратор полного цикла · Душанбе",
    v2_hero_t1:"Надёжная", v2_hero_t2:"инфраструктура",
    v2_hero_lead:"Полный цикл: проектирование, поставка, монтаж и сопровождение инженерных и IT-систем для бизнеса и крупных объектов.",
    v2_btn_discuss:"Обсудить проект",
    v2_badge:"Банки · Госсектор · Гостиницы · Бизнес-центры",
    v2_sec01:"01 — Восемь систем, один подрядчик", v2_sec02:"02 — Услуги",
    v2_sec03:"03 — О компании", v2_sec04:"04 — Решения",
    v2_sec05:"05 — 12 официальных вендоров", v2_sec06:"06 — Контакт",
    v2_services_h:"Полный цикл",
    v2_statement:"Единая ответственность за инфраструктуру объекта — от рабочей документации до сервиса 24/7",
    v2_sol_h:"Решения по отраслям", v2_years:"лет работы",
    v2_maps_hint:"Откройте адрес в удобных вам картах:",
    v2_sent_t:"Заявка отправлена", v2_sent_p:"Инженер свяжется с вами в течение рабочего дня.",
    v2_sent_again:"Отправить ещё одну",
    v2_about_lead:"IT-HONA — системный IT-интегратор полного цикла в Душанбе. Берём на себя весь путь от идеи до работающей инфраструктуры.",
    v2_about_p1:"Мы проектируем, поставляем, монтируем и сопровождаем инженерные и IT-системы: видеонаблюдение, СКУД, сети, серверные и ЦОД, LED-экраны, телефонию и аудиосистемы.",
    v2_whoneed_h:"Кому мы нужны", v2_inds_note:"Отрасли", v2_gov:"Госструктуры",
    v2_services_lead:"Единая ответственность за инфраструктуру объекта — от рабочей документации до сервиса 24/7. Без подрядчиков-посредников.",
    v2_how_h:"Как мы работаем", v2_how_note:"4 этапа", v2_svc_cta:"Нужна консультация инженера",
    v2_step1_t:"Заявка и аудит", v2_step1_d:"Выезд инженера, обследование объекта, уточнение задач.",
    v2_step2_t:"Проект и смета", v2_step2_d:"Техническое решение, документация, прозрачный бюджет.",
    v2_step3_t:"Поставка и монтаж", v2_step3_d:"Оборудование, монтаж, пусконаладка, сдача объекта.",
    v2_step4_t:"Сопровождение", v2_step4_d:"Гарантия, сервис 24/7, развитие инфраструктуры.",
    v2_solutions_lead:"Комплексы систем под задачи конкретного объекта: безопасность, сети, инженерная инфраструктура — в одном проекте.",
    v2_solb_d:"Безопасность и непрерывность работы отделений и головных офисов.",
    v2_solh_d:"Комфорт гостей и управляемость инфраструктуры отеля.",
    v2_solbc_t:"Бизнес-центры и госсектор", v2_solbc_d:"Слаботочные системы и инженерная инфраструктура зданий.",
    v2_sol_cta_h:"Не нашли свою отрасль", v2_sol_cta_p:"Соберём решение под ваш объект — от аудита до сопровождения.",
    v2_partners_h:"Оборудование мировых производителей",
    v2_partners_lead:"12 официальных вендоров: сертифицированные поставки, гарантия производителя, совместимость систем в одном проекте.",
    v2_bg1:"Сети и телекоммуникации", v2_bg2:"Безопасность и контроль доступа", v2_bg3:"Серверы, питание и инженерия",
  ...
  tj: {
    ...
    stat_quality:"кафолати сифат ва эътимоднокӣ",
    v2_eyebrow:"Интегратори системавии IT-и давраи пурра · Душанбе",
    v2_hero_t1:"Инфраструктураи", v2_hero_t2:"боэътимод",
    v2_hero_lead:"Давраи пурра: лоиҳакашӣ, таъминот, васлкунӣ ва хизматрасонии системаҳои муҳандисӣ ва IT барои бизнес ва иншооти калон.",
    v2_btn_discuss:"Муҳокимаи лоиҳа",
    v2_badge:"Бонкҳо · Бахши давлатӣ · Меҳмонхонаҳо · Марказҳои тиҷоратӣ",
    v2_sec01:"01 — Ҳашт система, як пудратчӣ", v2_sec02:"02 — Хизматрасониҳо",
    v2_sec03:"03 — Дар бораи ширкат", v2_sec04:"04 — Ҳалҳо",
    v2_sec05:"05 — 12 вендори расмӣ", v2_sec06:"06 — Тамос",
    v2_services_h:"Давраи пурра",
    v2_statement:"Масъулияти ягона барои инфраструктураи иншоот — аз ҳуҷҷатҳои корӣ то хизматрасонии 24/7",
    v2_sol_h:"Ҳалҳо аз рӯи соҳаҳо", v2_years:"соли фаъолият",
    v2_maps_hint:"Суроғаро дар харитаи барои шумо қулай кушоед:",
    v2_sent_t:"Дархост фиристода шуд", v2_sent_p:"Муҳандис дар давоми рӯзи корӣ бо шумо тамос мегирад.",
    v2_sent_again:"Боз як дархост фиристодан",
    v2_about_lead:"IT-HONA — интегратори системавии IT-и давраи пурра дар Душанбе. Тамоми роҳро аз ғоя то инфраструктураи амалкунанда бар дӯш мегирем.",
    v2_about_p1:"Мо системаҳои муҳандисӣ ва IT-ро лоиҳакашӣ, таъмин, васл ва хизматрасонӣ мекунем: видеосмушоҳида, СКУД, шабакаҳо, серверҳо ва ЦОД, экранҳои LED, телефония ва системаҳои аудио.",
    v2_whoneed_h:"Ба кӣ лозимем", v2_inds_note:"Соҳаҳо", v2_gov:"Сохторҳои давлатӣ",
    v2_services_lead:"Масъулияти ягона барои инфраструктураи иншоот — аз ҳуҷҷатҳои корӣ то хизматрасонии 24/7. Бе миёнаравҳо.",
    v2_how_h:"Чӣ тавр кор мекунем", v2_how_note:"4 марҳила", v2_svc_cta:"Ба машварати муҳандис ниёз доред",
    v2_step1_t:"Дархост ва аудит", v2_step1_d:"Ташрифи муҳандис, муоинаи иншоот, мушаххаскунии вазифаҳо.",
    v2_step2_t:"Лоиҳа ва смета", v2_step2_d:"Ҳалли техникӣ, ҳуҷҷатгузорӣ, буҷети шаффоф.",
    v2_step3_t:"Таъмин ва васл", v2_step3_d:"Таҷҳизот, васл, ба кор андохтан, супоридани иншоот.",
    v2_step4_t:"Ҳамроҳӣ", v2_step4_d:"Кафолат, хизмати 24/7, рушди инфраструктура.",
    v2_solutions_lead:"Маҷмӯи системаҳо мутобиқи вазифаҳои иншооти мушаххас: амният, шабакаҳо, инфраструктураи муҳандисӣ — дар як лоиҳа.",
    v2_solb_d:"Амният ва бефосилагии кори шӯъбаҳо ва офисҳои марказӣ.",
    v2_solh_d:"Осоиши меҳмонон ва идорашавандагии инфраструктураи меҳмонхона.",
    v2_solbc_t:"Марказҳои тиҷоратӣ ва бахши давлатӣ", v2_solbc_d:"Системаҳои камшиддат ва инфраструктураи муҳандисии биноҳо.",
    v2_sol_cta_h:"Соҳаи худро наёфтед", v2_sol_cta_p:"Барои иншооти шумо ҳал таҳия мекунем — аз аудит то ҳамроҳӣ.",
    v2_partners_h:"Таҷҳизоти истеҳсолкунандагони ҷаҳонӣ",
    v2_partners_lead:"12 вендори расмӣ: таъминоти сертификатсияшуда, кафолати истеҳсолкунанда, мувофиқати системаҳо дар як лоиҳа.",
    v2_bg1:"Шабакаҳо ва телекоммуникатсия", v2_bg2:"Амният ва назорати дастрасӣ", v2_bg3:"Серверҳо, ғизо ва муҳандисӣ",
  ...
  en: {
    ...
    stat_quality:"quality and reliability guarantee",
    v2_eyebrow:"Full-cycle system IT integrator · Dushanbe",
    v2_hero_t1:"Reliable", v2_hero_t2:"infrastructure",
    v2_hero_lead:"Full cycle: design, supply, installation and support of engineering and IT systems for business and large facilities.",
    v2_btn_discuss:"Discuss a project",
    v2_badge:"Banks · Government · Hotels · Business centers",
    v2_sec01:"01 — Eight systems, one contractor", v2_sec02:"02 — Services",
    v2_sec03:"03 — About us", v2_sec04:"04 — Solutions",
    v2_sec05:"05 — 12 official vendors", v2_sec06:"06 — Contact",
    v2_services_h:"Full cycle",
    v2_statement:"Single responsibility for the facility's infrastructure — from working documentation to 24/7 service",
    v2_sol_h:"Industry solutions", v2_years:"years in business",
    v2_maps_hint:"Open the address in your preferred maps:",
    v2_sent_t:"Request sent", v2_sent_p:"An engineer will contact you within one business day.",
    v2_sent_again:"Send another one",
    v2_about_lead:"IT-HONA is a full-cycle system IT integrator in Dushanbe. We handle the entire path from idea to working infrastructure.",
    v2_about_p1:"We design, supply, install and maintain engineering and IT systems: video surveillance, access control, networks, servers and data centers, LED screens, telephony and audio systems.",
    v2_whoneed_h:"Who we serve", v2_inds_note:"Industries", v2_gov:"Government",
    v2_services_lead:"Single responsibility for the facility's infrastructure — from working documentation to 24/7 service. No middlemen.",
    v2_how_h:"How we work", v2_how_note:"4 stages", v2_svc_cta:"Need an engineer's consultation",
    v2_step1_t:"Request & audit", v2_step1_d:"Engineer visit, site survey, clarifying the tasks.",
    v2_step2_t:"Design & estimate", v2_step2_d:"Technical solution, documentation, transparent budget.",
    v2_step3_t:"Supply & installation", v2_step3_d:"Equipment, installation, commissioning, handover.",
    v2_step4_t:"Support", v2_step4_d:"Warranty, 24/7 service, infrastructure development.",
    v2_solutions_lead:"System bundles tailored to a specific facility: security, networks, engineering infrastructure — in one project.",
    v2_solb_d:"Security and continuity for branches and head offices.",
    v2_solh_d:"Guest comfort and manageable hotel infrastructure.",
    v2_solbc_t:"Business centers & government", v2_solbc_d:"Low-voltage systems and building engineering infrastructure.",
    v2_sol_cta_h:"Didn't find your industry", v2_sol_cta_p:"We'll build a solution for your facility — from audit to support.",
    v2_partners_h:"Equipment from world-class manufacturers",
    v2_partners_lead:"12 official vendors: certified supply, manufacturer warranty, system compatibility in one project.",
    v2_bg1:"Networks & telecommunications", v2_bg2:"Security & access control", v2_bg3:"Servers, power & engineering",
